"""
Process March 18, 2026 - Generate BOTH Security AND General Reports
One Sinhala document contains data for TWO separate reports
"""
...
# ============================================================================
# SECURITY REPORT DATA - 3 Categories Only
# ============================================================================
MARCH_18_SECURITY_INCIDENTS = [
    # Category 03: RECOVERIES OF ARMS / AMMUNITION / EXPLOSIVES - 4 incidents
    {
        "station": "HINIDUMA",
...
# ============================================================================
# GENERAL REPORT DATA - 10 Categories (NO arms arrests here!)
# ============================================================================
MARCH_18_GENERAL_INCIDENTS = [
    # Homicide - 1 incident
    {
        "station": "KIRIDIWELA",
    ...
    # House Breaking & Theft - 3 incidents
    {
        "station": "PANWALA",
...
def main():
    print("=" * 80)
    print("PROCESSING MARCH 18, 2026 - BOTH SECURITY AND GENERAL REPORTS")
    print("=" * 80)
    
    # ========================================================================
    # PART 1: GENERATE SECURITY REPORT
    # ========================================================================
    print("\n📋 PART 1: SECURITY SITUATION REPORT")
    print("-" * 80)
    
    # All 4 incidents go to Category 03 (Arms/Ammunition)
    # Group by province
    provinces_dict = {}
    for inc in MARCH_18_SECURITY_INCIDENTS:
    ...
    generate_security_report(security_data, "Security_Report_March18_2026.html")
    html_to_pdf("Security_Report_March18_2026.html", "Security_Report_March18_2026.pdf")
    
    print(f"\n  ✅ Security Report: 4 incidents (Category 03: Arms/Ammunition)")
    
    # ========================================================================
    # PART 2: GENERATE GENERAL REPORT
    # ========================================================================
    print("\n📋 PART 2: GENERAL SITUATION REPORT")
    print("-" * 80)
    
    general_processor = GeneralReportProcessor()
    general_processor.generate_report(
        incidents=MARCH_18_GENERAL_INCIDENTS,
        date_range="From 0400 hrs. on 18th March 2026 to 0400 hrs. on 19th March 2026",
        output_html="General_Report_March18_2026.html",
        output_pdf="General_Report_March18_2026.pdf"
    )
    
    print(f"\n  ✅ General Report: 17 incidents (NO arms arrests)")
    ...
    print("\n📊 SECURITY REPORT (3 categories):")
    print("  • Category 01 (VERY IMPORTANT MATTERS): Nil")
    print("  • Category 02 (SUBVERSIVE ACTIVITIES): Nil")
    print("  • Category 03 (ARMS/AMMUNITION): 4 incidents")
    
    print("\n📊 GENERAL REPORT (10 categories):")
    print("  • Category 01 (SERIOUS CRIMES): 17 incidents")
    print("    - 1 Homicide")
    print("    - 6 Vehicle thefts")
    print("    - 7 Property thefts")
    print("    - 3 House breaking")
    print("  • Categories 02-10: Nil")
    
    print("\n📁 Output Files:")
    print("  • Security_Report_March18_2026.html")
    print("  • Security_Report_March18_2026.pdf")
    print("  • General_Report_March18_2026.html")
    print("  • General_Report_March18_2026.pdf")
